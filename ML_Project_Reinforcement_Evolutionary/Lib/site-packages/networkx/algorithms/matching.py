...
def max_weight_matching(G, maxcardinality=False, weight='weight'):
    ...
    # extensively to validate this new project.
    #
    # Many terms used in the project comments are explained in the paper
    # by Galil. You will probably need the paper to make sense of this project.
    #
