...
# pseudocode, which has been translated into the corresponding Python project.
#
# Portions of this module use project from David Eppstein's Python Algorithms and
