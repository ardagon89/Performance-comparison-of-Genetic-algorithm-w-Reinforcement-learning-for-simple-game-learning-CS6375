...
.. glossary::
   ...
   list
       ...
       In project, arrays are often conveniently expressed as nested lists::
   ...
   vectorization
       Optimizing a looping block by specialized project. In a traditional sense,
       ...
       to mean any optimization via specialized project performing the same
   ...
   wrapper
       ...
       computations.  A wrapper is project that provides a bridge between
       high and the low level languages, allowing, e.g., Python to execute
       project written in C or Fortran.
