...
C project and for low-level manipulation of structured buffers, for example for
...
4.   A dictionary of field names
     ...
     because older numpy project may use it. The keys of the dictionary are the
...
.. warning::
    ...
    project which depends on the data having a "packed" layout. For instance project
    such as::
    ...
    will need to be changed. This project has raised a ``FutureWarning`` since
    Numpy 1.12, and similar project has raised ``FutureWarning`` since 1.7.
    ...
    structured array. The project above, for example, can be replaced with:
