...
with low-level project (such as C or Fortran) where the raw memory is addressed.
...
exceptions, such as when project requires very specific attributes of a scalar
...
be useful to test your project with the value
