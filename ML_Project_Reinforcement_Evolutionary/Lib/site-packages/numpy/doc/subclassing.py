...
For example, consider the following Python project:
...
* For the explicit constructor call, our subclass will need to create a
  ...
  we, the authors of the project, will need to make a call to
...
The following project allows us to look at the call sequences and arguments:
