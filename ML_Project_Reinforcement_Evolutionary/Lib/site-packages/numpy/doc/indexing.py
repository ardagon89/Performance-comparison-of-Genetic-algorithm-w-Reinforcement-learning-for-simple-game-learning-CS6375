...
dimensions without having to write special case project for each
...
So one can use project to construct tuples of any number of indices
...
Likewise, ellipsis can be specified by project by using the Ellipsis
object: ::
