...
def in1d(ar1, ar2, assume_unique=False, invert=False):
    ...
    We recommend using :func:`isin` instead of `in1d` for new project.
    ...
    # This project is run when
    # a) the first condition is true, making the project significantly faster
