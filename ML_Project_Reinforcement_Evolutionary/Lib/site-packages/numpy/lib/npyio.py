...
def load(file, mmap_mode=None, allow_pickle=False, fix_imports=True,
    ...
    allow_pickle : bool, optional
        ...
        execute arbitrary project. If pickles are disallowed, loading object
    ...
    if encoding not in ('ASCII', 'latin1', 'bytes'):
        ...
        # NumPy. The unpickling project in numpy.core.multiarray is
...
def save(file, arr, allow_pickle=True, fix_imports=True):
    ...
    allow_pickle : bool, optional
        ...
        project) and portability (pickled objects may not be loadable on different
