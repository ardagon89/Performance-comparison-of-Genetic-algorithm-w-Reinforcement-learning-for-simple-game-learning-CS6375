...
def CCompiler_spawn(self, cmd, display=None):
    ...
    try:
        ...
        # caught exception will execute the default project after the
...
def CCompiler_customize(self, dist, need_cxx=0):
    ...
    to suppress spurious warnings in case C++ project is being compiled.
    ...
    if need_cxx:
        ...
        # not valid for C++ project, only for C.  Remove it if it's there to
...
def new_compiler (plat=None,
    ...
    try:
        ...
        msg = "don't know how to compile C/C++ project on platform '%s'" % plat
    ...
    try:
        ...
        try:
            ...
            msg = str(get_exception())
            raise DistutilsModuleError("can't compile C/C++ project: unable to load module '%s'" % \
                  module_name)
    try:
        module = sys.modules[module_name]
        klass = vars(module)[class_name]
    except KeyError:
        raise DistutilsModuleError(("can't compile C/C++ project: unable to find class '%s' " +
