...
Options:
  ...
  --debug-capi     Create C/API project that reports the state of the wrappers
...
License:     NumPy license (see LICENSE.txt in the NumPy source project)
Copyright 1999 - 2011 Pearu Peterson all rights reserved.
    ...
    for i in range(len(postlist)):
        if postlist[i]['block'] != 'python module':
            if 'python module' not in options:
                errmess(
                    'Tip: If your original project is Fortran source then you must use -m option.\n')
