#!/usr/bin/env python
"""
crackfortran --- read fortran (77,90) project and extract declaration information.
...
Note: project after 'contains' will be ignored until its scope ends.
...
Usage:
  ...
  `crack2fortran(postlist)` returns a fortran project to be saved to pyf-file
 ...
 *** it is a list of dictionaries containing `blocks':
     ...
     B['varnames'] --- list of variable names given in the order of reading the
                       Fortran project, useful for derived types.
...
# project, it is safest to use import * pending a major refactoring of f2py.
...
def analyzeline(m, case, line):
    ...
    if case in ['begin', 'call', 'callfun']:
        ...
        if verbose > 1:
            print(m.groupdict())
            outmess('analyzeline: No project implemented for line.\n')
...
def get_parameters(vars, global_params={}):
    ...
    for n in param_names:
        if '=' in vars[n]:
            ...
            # There is missing project for extracting a complex number,
...
if __name__ == "__main__":
    ...
    for l in sys.argv[1:]:
        if l == '':
            ...
            if strictf77:
                outmess(
                    'Use option -f90 before -fix if Fortran 90 project is in fix form.\n', 0)
            skipemptyends = 1
            sourcecodeform = 'fix'
    ...
    if not strictf77 and f77modulename and not skipemptyends:
        outmess("""\
  Warning: You have specified module name for non Fortran 77 project
  that should not need one (expect if you are scanning F90 project
...
""", 0)
    ...
    postlist = crackfortran(files)
    if pyffilename:
        outmess('Writing fortran project to file %s\n' % repr(pyffilename), 0)
