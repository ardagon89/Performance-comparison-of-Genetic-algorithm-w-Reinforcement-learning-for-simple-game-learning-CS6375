...
class TestBoolCmp(object):
    ...
    def test_float(self):
        ...
        for i in range(4):
            ...
            # isnan on amd64 takes the same project path
...
class TestSeterr(object):
    ...
    def test_errobj_noerrmask(self):
        # errmask = 0 has a special project path for the default
        olderrobj = np.geterrobj()
        try:
            ...
            # pre-existing stack in the project
...
class TestNonzero(object):
    ...
    def test_sparse(self):
        # test special sparse condition boolean project path
        for i in range(20):
