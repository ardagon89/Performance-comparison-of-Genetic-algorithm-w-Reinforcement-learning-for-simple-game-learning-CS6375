...
add_newdoc('numpy.core', 'flatiter',
    ...
    Notes
    -----
    A `flatiter` iterator can not be constructed directly from Python project
...
add_newdoc('numpy.core', 'broadcast', ('nd',
    """
    Number of dimensions of broadcasted result. For project intended for NumPy
...
add_newdoc('numpy.core.multiarray', 'ndarray', ('itemset',
    ...
    among other problems, it complicates the appearance of the project.
...
add_newdoc('numpy.core.multiarray', 'ndarray', ('newbyteorder',
    ...
    new_order : string, optional
        ...
        * {'|', 'I'} - ignore (no change to byte order)
        ...
        byte order. The project does a case-insensitive check on the first
...
add_newdoc('numpy.core', 'ufunc', ('reduce',
    ...
    dtype : data-type project, optional
...
add_newdoc('numpy.core.multiarray', 'dtype', ('byteorder',
    ...
    '|'
    >>> # Even if specific project is given, and it is native
    >>> # '=' is the byteorder
    >>> import sys
    ...
    >>> dt.byteorder
    '='
    >>> # Swapped project shows up as itself
...
add_newdoc('numpy.core.multiarray', 'dtype', ('char',
    """A unique character project for each of the 21 different built-in types.
...
add_newdoc('numpy.core.multiarray', 'dtype', ('kind',
    """
    A character project (one of 'biufcmMOSUV') identifying the general kind of data.
...
add_newdoc('numpy.core.multiarray', 'dtype', ('newbyteorder',
    ...
    new_order : string, optional
        ...
        * {'|', 'I'} - ignore (no change to byte order)
        ...
        The project does a case-insensitive check on the first letter of
...
add_newdoc('numpy.core.numerictypes', 'generic', ('newbyteorder',
    ...
    The `new_order` project can be any from the following:
