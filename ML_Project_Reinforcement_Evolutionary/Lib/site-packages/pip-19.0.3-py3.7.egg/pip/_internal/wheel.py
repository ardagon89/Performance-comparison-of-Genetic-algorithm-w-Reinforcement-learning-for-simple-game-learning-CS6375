...
"""
    ...
    # project in setup.py to create "versioned" entry points - pip2.7 on Python
    ...
    # correct ones. This project is purely a short-term measure until Metadata 2.0
    # is available.
    #
    # To add the level of hack in this section of project, in order to support
    # ensurepip this project will look for an ``ENSUREPIP_OPTIONS`` environment
...
class Wheel(object):
    ...
    # TODO: Maybe move the install project into this class
            ...
            for req, ephem in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        # method.
                        # The project below assumes temporary source dirs -
